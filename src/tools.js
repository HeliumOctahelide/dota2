...
// 从以下网址获取heroid：https://api.steampowered.com/IEconDOTA2_570/GetHeroes/v0001/?key=APIKEY&language=zh_cn
...
let hero_id_dict = {};
for (let i of HERO_ID) {
    hero_id_dict[i.id] = {
        name: i.name.substring(14),
